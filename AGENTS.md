...
| architect | `claude-opus-4-7`    | `claude-code`   | `spec/`, `docs/adr/`, `docs/design/`, `prompt/`             | `packages/**/src/`, production code       |
| builder   | `gpt-5-4`            | `codex`         | `packages/`, tests, `trace/<phase>/`, infra configs         | `spec/` (frozen), `docs/adr/` (accepted)  |
