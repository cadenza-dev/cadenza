...
├── .codex/                   ← generated Codex prompt bridge artifacts
...
- **Codex** → `.codex/prompts/cadenza-*.md` (generated) → user-scope `~/.codex/prompts/cadenza-*.md` (installed per developer via `scripts/install-codex-commands.sh`; invoked as `/prompts:cadenza-<name>`).
